...
import fr.zm.bankaccount.restapi.dto.WithdrawalRequest;
...
public class AccountController {
    ...
    public ResponseEntity<String> withdraw(@PathVariable String clientId, @RequestBody WithdrawalRequest request) {
        TransactionResponseDTO response = transactionService.withdraw(clientId, LocalDate.now(), request.getAmount());
